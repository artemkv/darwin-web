...
namespace Artemkv.Darwin.Server
{
	...
	public class Assembler
	{
		...
		/// <returns></returns>
		public ERModel.PersistentObject GetRealObject(RESTModel.PersistentObject dto, ISession session)
        {
			if (dto == null)
		...
		private void BuildDTOSimpleProperties(RESTModel.PersistentObject dto, ERModel.PersistentObject real)
		{
		...
		private void BuildDTOObjectProperties(RESTModel.PersistentObject dto, ERModel.PersistentObject real)
		{
		...
		private void SetParent(dynamic real, RESTModel.PersistentObject dto, ISession session)
		{
			Type dtoType = dto.GetType();
