...
namespace Artemkv.Darwin.Server
{
	public class Validator
	{
		...
		public ValidationError Validate(PersistentObject obj, string propertyName)
		{
		...
		private List<ValidationError> ValidateSimpleProperties(PersistentObject obj)
		{
		...
		private List<ValidationError> ValidateObjectCollections(PersistentObject obj)
		{
			var errors = new List<ValidationError>();
			...
			foreach (var collectionProp in collectionProps)
			{
				...
				foreach (PersistentObject itemDTO in items)
				{
		...
		private ValidationError Validate(PersistentObject obj, PropertyInfo propToValidate)
		{
